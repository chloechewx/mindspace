          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-2 md:col-span-2 lg:col-span-3">
              ...
              <select
                ...
                className="w-full px-4 py-3 border-2 border-sage-300 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-sage-500 bg-white text-gray-800 font-medium"
              >
